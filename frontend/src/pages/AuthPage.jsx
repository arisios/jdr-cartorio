      ...
      <div className="flex-1 flex items-center justify-center px-4 py-8">
        <div className="w-full max-w-sm animate-slide-up">
          <div className="text-center mb-8">
            ...
            <h1 className="font-display text-2xl font-bold" style={{color:'#4B1E6D'}}>Cartório Junino</h1>
            <p className="text-sm mt-1" style={{color:'rgba(58,31,20,0.4)'}}>Juninas do Rio 2026</p>
          </div>
          <div className="card-junina p-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <input className="input-junina" name="identifier"
              ...
              <div>
                <label className="block text-xs font-bold mb-1.5 uppercase tracking-wider" style={{color:'#4B1E6D'}}>Senha</label>
                <input className="input-junina" type="password" name="password"
